...
class Shipment(Base):
    ...
    price_1688 = Column(ARRAY(Numeric(12, 4), nullable=True))
    link_address_1688 = Column(ARRAY(Text), nullable=True)
    variation_name_1688 = Column(ARRAY(Text), nullable=True)
